...
/**
 * DataOutputStream - 기본형 데이터를 좀더 편리하게 읽고 쓸수 있습니다.
 */
...
public class DataInputOutput {
	...
	public static void main(String[] args) throws Exception {
		...
		// DataOutputStream 생성
		// FileOutputStram fos = new FileOutputStream("C:/filetest/prinitive.db");
		...
		// FileOutputStream을 기반으로 기본형 자료를 좀더 편리하게 읽고/쓰기 위함.
		DataOutputStream dos = new DataOutputStream(fos);

		// 기본 타입 출력
		dos.writeUTF("홍길동"); // UTF-8 형식으로 인코딩하여 문자열 출력
		dos.writeDouble(95.5); // double type 저장
		dos.writeInt(1); // int type 저장
